...
Usage:
    vaeModel.py [--tub=<tub1,tub2,..tubn>] [--file=<file> ...]
'''
...
from tensorflow.python.keras.layers import Reshape, Conv2DTranspose, Convolution2D, Dropout
...
#new Model Adric
x = Conv2DTranspose(64, (3,3), strides=(1,1), activation='relu', name="deconv2d_5")(x) 
x = Dropout(drop)(x)
if input_shape[0] > 64 :
    x = Conv2DTranspose(64, (3,3), strides=(2,2), activation='relu', name="deconv2d_4")(x)       # 64 features, 3px3p kernal window, 2wx2h stride, relu
elif input_shape[0] > 32 :
    x = Conv2DTranspose(64, (3,3), strides=(1,1), activation='relu', name="deconv2d_4")(x)  
if input_shape[0] > 32 :
    x = Conv2DTranspose(64, (5,5), strides=(2,2), activation='relu', name="deconv2d_3")(x)       # 64 features, 5px5p kernal window, 2wx2h stride, relu
else:
    x = Conv2DTranspose(64, (3,3), strides=(1,1), activation='relu', name="deconv2d_3")(x)       # 64 features, 5px5p kernal window, 2wx2h stride, relu
x = Dropout(drop)(x)  
x = Conv2DTranspose(32, (5,5), strides=(2,2), activation='relu', name="deconv2d_2")(x)       # 32 features, 5px5p kernel window, 2wx2h stride, relu activatiion
x = Dropout(drop)(x)   
x = Conv2DTranspose(24, (5,5), strides=(2,2), activation='relu', name="deconv2d_1")(x)       # 24 features, 5 pixel x 5 pixel kernel (convolution, feauture) window, 2wx2h stride, relu activation
...
if __name__ == '__main__':
    ...
    records = gather_records(cfg, tub, opts, verbose=True)
